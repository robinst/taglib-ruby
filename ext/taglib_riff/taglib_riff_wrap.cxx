...
#define SWIGTYPE_p_TagLib__RIFF__File swig_types[1]
...
#define SWIG_init    Init_taglib_riff
#define SWIG_name    "TagLib::RIFF"
...
SWIGINTERN void
free_TagLib_RIFF_File(TagLib::RIFF::File *arg1) {
...
static swig_cast_info _swigc__p_TagLib__File[] = {  {&_swigt__p_TagLib__File, 0, 0, 0},  {&_swigt__p_TagLib__RIFF__File, _p_TagLib__RIFF__FileTo_p_TagLib__File, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_TagLib__RIFF__File[] = {  {&_swigt__p_TagLib__RIFF__File, 0, 0, 0},{0, 0, 0, 0}};
...
extern "C"
#endif
SWIGEXPORT void Init_taglib_riff(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRIFF = rb_define_module("TagLib");
  mRIFF = rb_define_module_under(mRIFF, "RIFF");
  ...
  SwigClassFile.klass = rb_define_class_under(mRIFF, "File", ((swig_class *) SWIGTYPE_p_TagLib__File->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_TagLib__RIFF__File, (void *) &SwigClassFile);
  rb_undef_alloc_func(SwigClassFile.klass);
  SwigClassFile.mark = 0;
  SwigClassFile.destroy = (void (*)(void *)) free_TagLib_RIFF_File;
