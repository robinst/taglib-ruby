...
_wrap_new_Properties__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "TagLib::AudioProperties::ReadStyle","TagLib::RIFF::WAV::Properties", 2, argv[1] ));
  } 
...
_wrap_new_Properties__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "TagLib::uint","TagLib::RIFF::WAV::Properties", 2, argv[1] ));
  } 
  arg2 = static_cast< TagLib::uint >(val2);
  ecode3 = SWIG_AsVal_int(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "TagLib::AudioProperties::ReadStyle","TagLib::RIFF::WAV::Properties", 3, argv[2] ));
  } 
...
_wrap_new_File__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "bool","TagLib::RIFF::WAV::File", 2, argv[1] ));
  } 
  arg2 = static_cast< bool >(val2);
  ecode3 = SWIG_AsVal_int(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "TagLib::RIFF::WAV::Properties::ReadStyle","TagLib::RIFF::WAV::File", 3, argv[2] ));
  } 
