...
fail:
  Ruby_Format_OverloadedError( argc, 4, "File.new", 
    ...
    "    File.new(IOStream *stream, bool readProperties, TagLib::RIFF::AIFF::Properties::ReadStyle propertiesStyle, TagLib::ID3v2::FrameFactory *frameFactory)\n");
...
SWIGEXPORT void Init_taglib_aiff(void) {
  ...
  rb_define_module_function(mAIFF, "picture_type_to_string", VALUEFUNC(_wrap_picture_type_to_string), -1);
  rb_define_module_function(mAIFF, "picture_type_from_string", VALUEFUNC(_wrap_picture_type_from_string), -1);
