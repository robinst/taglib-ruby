...
/*
  ...
  call-seq:
    find(pattern, fromOffset=0, before=TagLib::ByteVector()) -> offset_t
    find(pattern, fromOffset=0) -> offset_t
    find(pattern) -> offset_t
...
_wrap_File_find__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_offset_t,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "offset_t","find", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "offset_t","find", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< offset_t * >(argp3));
    }
  }
  {
  ...
  vresult = SWIG_NewPointerObj((new offset_t(result)), SWIGTYPE_p_offset_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN VALUE _wrap_File_find(int nargs, VALUE *args, VALUE self) {
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_offset_t, SWIG_POINTER_NO_NULL);
        _v = SWIG_CheckState(res);
        if (_v) {
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "File.find", 
    "    offset_t File.find(TagLib::ByteVector const &pattern, offset_t fromOffset, TagLib::ByteVector const &before)\n"
    "    offset_t File.find(TagLib::ByteVector const &pattern, offset_t fromOffset)\n"
    "    offset_t File.find(TagLib::ByteVector const &pattern)\n");
...
_wrap_File_rfind__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_offset_t,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "offset_t","rfind", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "offset_t","rfind", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< offset_t * >(argp3));
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "File.rfind", 
    "    offset_t File.rfind(TagLib::ByteVector const &pattern, offset_t fromOffset, TagLib::ByteVector const &before)\n"
    "    offset_t File.rfind(TagLib::ByteVector const &pattern, offset_t fromOffset)\n"
    "    offset_t File.rfind(TagLib::ByteVector const &pattern)\n");
...
_wrap_File_insert__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_offset_t,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "offset_t","insert", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "offset_t","insert", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< offset_t * >(argp3));
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "File.insert", 
    "    void File.insert(TagLib::ByteVector const &data, offset_t start, size_t replace)\n"
    "    void File.insert(TagLib::ByteVector const &data, offset_t start)\n"
...
_wrap_File_remove_block__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< TagLib::File * >(argp1);
  {
    res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_offset_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "offset_t","removeBlock", 2, argv[0] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "offset_t","removeBlock", 2, argv[0]));
    } else {
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "File.remove_block", 
    "    void File.remove_block(offset_t start, size_t length)\n"
    "    void File.remove_block(offset_t start)\n"
...
_wrap_File_seek__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< TagLib::File * >(argp1);
  {
    res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_offset_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "offset_t","seek", 2, argv[0] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "offset_t","seek", 2, argv[0]));
    } else {
      arg2 = *(reinterpret_cast< offset_t * >(argp2));
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "File.seek", 
    "    void File.seek(offset_t offset, TagLib::File::Position p)\n"
...
SWIGEXPORT void Init_taglib_base(void) {
  ...
  rb_define_module_function(mTagLib, "picture_type_to_string", VALUEFUNC(_wrap_picture_type_to_string), -1);
  rb_define_module_function(mTagLib, "picture_type_from_string", VALUEFUNC(_wrap_picture_type_from_string), -1);
