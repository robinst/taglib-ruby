...
#define SWIGTYPE_p_TagLib__MP4__IntPair swig_types[14]
#define SWIGTYPE_p_TagLib__MP4__Item swig_types[15]
...
_wrap_new_AtomData(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "TagLib::MP4::AtomDataType","AtomData", 1, argv[0] ));
  } 
  arg1 = static_cast< TagLib::MP4::AtomDataType >(val1);
  {
    res2 = SWIG_ConvertPtr(argv[1], &argp2, SWIGTYPE_p_TagLib__ByteVector,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "TagLib::ByteVector","AtomData", 2, argv[1] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "TagLib::ByteVector","AtomData", 2, argv[1]));
    } else {
...
_wrap_new_Atom(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_TagLib__MP4__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::MP4::File *","Atom", 1, argv[0] )); 
  }
  arg1 = reinterpret_cast< TagLib::MP4::File * >(argp1);
...
_wrap_new_Atoms(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_TagLib__MP4__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::MP4::File *","Atoms", 1, argv[0] )); 
  }
  arg1 = reinterpret_cast< TagLib::MP4::File * >(argp1);
...
_wrap_new_Item__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "TagLib::uchar","Item", 1, argv[0] ));
  } 
...
_wrap_new_Item__SWIG_4(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "TagLib::uint","Item", 1, argv[0] ));
  } 
...
_wrap_new_File__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::IOStream *","File", 1, argv[0] )); 
  }
  arg1 = reinterpret_cast< TagLib::IOStream * >(argp1);
  ecode2 = SWIG_AsVal_bool(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
