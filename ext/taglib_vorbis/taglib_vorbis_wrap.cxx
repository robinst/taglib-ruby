...
SWIGEXPORT void Init_taglib_vorbis(void) {
  ...
  rb_define_module_function(mVorbis, "picture_type_to_string", VALUEFUNC(_wrap_picture_type_to_string), -1);
  rb_define_module_function(mVorbis, "picture_type_from_string", VALUEFUNC(_wrap_picture_type_from_string), -1);
